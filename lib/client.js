...
`;
		...
		const api = {
			...
			qqCookieSave(cookie) {
				return post$1("/auth/qq", { cookie });
			},
			qqQrStart() {
				return post$1("/auth/qq/qr", {});
			},
			...
			haloSetConfig(config) {
				return post$1("/halo/config", { config });
			},
			getPluginSettings() {
				return get("/settings");
			},
			savePluginSettings(patch) {
				return post$1("/settings/save", { settings: patch });
			},
			scheduleStatus() {
				return get("/schedule");
			},
			alarmAdd(time, keyword, label) {
				return post$1("/alarm/add", {
					time,
					keyword,
					label
				});
			...
			alarmRemove(id) {
				return post$1("/alarm/remove", { id });
			},
			sleepSet(minutes) {
				return post$1("/sleep/set", { minutes });
			},
			sleepClear() {
				return post$1("/sleep/clear", {});
			},
			...
			createList(name) {
				return post$1("/list/create", { name });
			},
			deleteList(id) {
				return post$1("/list/delete", { id });
			},
			addToList(id, track) {
				return post$1("/list/add", {
					id,
					track
				});
			},
			removeFromList(id, trackId) {
				return post$1("/list/remove", {
					id,
					trackId
				});
			},
			...
			toggleProvider(id, enabled) {
				return post$1("/providers/toggle", {
					id,
					enabled
				});
			}
		...
		*/
		...
		audio.addEventListener("play", () => {
			set$2({ playing: true });
			api.haloState(true).catch(() => {});
		});
		audio.addEventListener("pause", () => {
			set$2({ playing: false });
			api.haloState(false).catch(() => {});
		});
		...
		function commitPlay(track, url) {
			...
			loadLyric(track.id);
			pushHaloNowPlaying(track);
		}
		/** 推歌名 + 播放态到花再音响（HID 屏幕）；失败静默。 */
		function pushHaloNowPlaying(track) {
			api.haloSong(track.name, track.artists.join(" / ")).catch(() => {});
			api.haloState(true).catch(() => {});
			lastHaloLine = "";
		}
		/** 当前歌词行变化即推送到花再音响（去重）。 */
		function pushHaloLyricLine() {
...
`;
		...
		*/
					...
					tab !== "settings" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: ["队列", getPlayerState().queue.length > 0 ? `(${getPlayerState().queue.length})` : ""]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
		...
		function SettingsView() {
			...
			const [halo, setHalo] = (0, react.useState)(null);
			...
			const [haloOpen, setHaloOpen] = (0, react.useState)(true);
			(0, react.useEffect)(() => {
				const loadHalo = () => {
					api.haloStatus().then(({ halo }) => setHalo(halo)).catch(() => {});
				};
				loadHalo();
				const haloTimer = window.setInterval(loadHalo, 2e3);
			...
			const patchHalo = (0, react.useCallback)((patch) => {
				api.haloSetConfig(patch).then(() => api.haloStatus()).then(({ halo }) => {
					setHalo(halo);
					setSavedNote("已保存");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["花再音箱（HALO PixelBar）", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshm-set-state",
							children: halo ? halo.simulated ? "模拟模式(未装node-hid)" : halo.connected ? "已连接" : "未连接" : ""
						})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: haloOpen ? "▾" : "▸" })]
					}),
					haloOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						className: "dshm-check-row",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
					...
					}), halo?.enabled && halo?.connected ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dshm-mini",
							onClick: () => {
								api.haloLyric("花再歌词同步测试 123").then(() => {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							className: "dshm-set-row",
							children: ["歌词对齐", /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
								className: "dshm-select",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							className: "dshm-set-row",
							children: ["每行字数", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								className: "dshm-num",
								type: "number",
								min: 10,
								max: 40,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							className: "dshm-set-row",
							children: ["通知时长(秒)", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								className: "dshm-num dshm-time",
								type: "number",
								min: 0,
								max: 120,
					...
					] }) : halo?.enabled && !halo?.connected ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshm-note",
						children: ["音箱未连接，请检查 USB 连接", (halo.hidError || halo.connectError) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("br", {}),
							"原因：",
							halo.hidError || halo.connectError
						] })]
					}) : null] }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: track.provider === "netease" ? "网" : "Q"
							}),
		...
		function AuthTab() {
			...
			const refresh = (0, react.useCallback)(() => {
				api.authStatus().then(({ providers }) => setItems(providers)).catch(() => {});
			}, []);
							...
							qqQr.phase === "idle" || qqQr.phase === "given-up" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: [qqQr.img && qqQr.phase !== "success" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
									...
									children: [
										...
										qqQr.note && qqQr.phase !== "success" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("br", {}), qqQr.note] })
									]
								})]
							}),
		...
		//#endregion
		//#region src/client/haloBridge.ts
		/**
		...
		*/
		...
		async function refreshConfig() {
			...
			let sig = statusSig;
			try {
				const halo = (await (await fetch("/api/dsh-music/halo/status")).json()).halo;
			...
			if (nextEnabled && !enabled) {
				...
				lastSongSig = "";
			} else if (nextEnabled && sig !== statusSig) lastLine = "__init__";
			statusSig = sig;
			enabled = nextEnabled;
		}
		/** 启动桥循环。幂等。 */
		function startHaloBridge() {
			const flags = globalThis;
